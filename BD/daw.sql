...
(
	ID NUMBER(3) GENERATED ALWAYS AS IDENTITY MAXVALUE 999 CONSTRAINT PAR_ID_PK PRIMARY KEY,
...
(
	ID NUMBER(2) GENERATED ALWAYS AS IDENTITY MAXVALUE 999 CONSTRAINT PERS_ID_PK PRIMARY KEY,
	NOMBRE VARCHAR2(30),
	APELLIDOS VARCHAR2(50),
	DNI VARCHAR2(9),
	TELEFONO VARCHAR2(9),
    ...
    IMG VARCHAR2(250),
		...
		CONSTRAINT PERS_OFI_CK CHECK (UPPER(OFICIO) IN (UPPER('PRESIDENTE'), UPPER('ENTRENADOR'), UPPER('STAFF')))
);
