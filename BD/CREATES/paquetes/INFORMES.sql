    ...
    CREATE OR REPLACE PROCEDURE INFORME_EQUIPO (C_INFORME OUT TCURSOR, NOMBRE_EQUIPO IN VARCHAR) AS
...
/
    ...
    CREATE OR REPLACE PROCEDURE INFORME_PARTIDOS_POR_JORNADA (C_PARTIDOS OUT TCURSOR) AS
    BEGIN
