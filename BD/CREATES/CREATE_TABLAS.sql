...
(
    ...
    ID_SPLIT NUMBER(2),
        ...
        CONSTRAINT JOR_IDSPLIT_FK FOREIGN KEY (ID_SPLIT) REFERENCES SPLITS(ID) ON DELETE CASCADE
...
(
	...
	ID_EQUIPO2 NUMBER(2),
		...
		CONSTRAINT PAR_IDJORNADA_FK FOREIGN KEY (ID_JORNADA) REFERENCES JORNADAS(ID) ON DELETE CASCADE,
...
(
	...
	SUELDO NUMBER(8),
		...
		CONSTRAINT CONTRAJUG_IDJUG_FK FOREIGN KEY (ID_JUGADOR) REFERENCES JUGADORES(ID) ON DELETE CASCADE,
...
(
	...
	SUELDO NUMBER(8),
		...
		CONSTRAINT CONPER_IDPERSONAL_FK FOREIGN KEY (ID_PERSONAL) REFERENCES PERSONALES(ID)ON DELETE CASCADE
);
